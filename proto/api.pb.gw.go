...
func request_ProdService_GetVendorProdTypes_0(ctx context.Context, marshaler runtime.Marshaler, client ProdServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	msg, err := client.GetVendorProdTypes(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err

}

func local_request_ProdService_GetVendorProdTypes_0(ctx context.Context, marshaler runtime.Marshaler, server ProdServiceServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ClientRequestType
	var metadata runtime.ServerMetadata
	...
	msg, err := server.GetVendorProdTypes(ctx, &protoReq)
	return msg, metadata, err
...
func request_ProdService_GetVendorProds_0(ctx context.Context, marshaler runtime.Marshaler, client ProdServiceClient, req *http.Request, pathParams map[string]string) (ProdService_GetVendorProdsClient, runtime.ServerMetadata, error) {
	...
	stream, err := client.GetVendorProds(ctx, &protoReq)
	if err != nil {
...
func RegisterProdServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ProdServiceServer) error {
	...
	mux.Handle("GET", pattern_ProdService_GetVendorProdTypes_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_ProdService_GetVendorProdTypes_0(rctx, inboundMarshaler, server, req, pathParams)
		...
		forward_ProdService_GetVendorProdTypes_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterProdServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ProdServiceClient) error {
	...
	mux.Handle("GET", pattern_ProdService_GetVendorProdTypes_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ProdService_GetVendorProdTypes_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_ProdService_GetVendorProds_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_ProdService_GetVendorProds_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_ProdService_GetVendorProds_0(ctx, mux, outboundMarshaler, w, req, func() (proto.Message, error) { return resp.Recv() }, mux.GetForwardResponseOptions()...)
...
var (
	forward_ProdService_GetVendorProdTypes_0 = runtime.ForwardResponseMessage

	forward_ProdService_GetVendorProds_0 = runtime.ForwardResponseStream
)
